/*
  # Fix RLS Policies for Universal Team Access

  1. Problem Analysis
    - Current policies still restrict access by user ownership
    - Users can only see their own projects and profiles
    - Team collaboration is broken

  2. Solution
    - Drop all existing restrictive policies
    - Create true universal access policies for authenticated users
    - Ensure all authenticated users can access ALL data

  3. Tables Affected
    - profiles: Universal read/write access
    - projects: Universal CRUD access
...
-- Test query to verify universal access works
-- This should return ALL projects regardless of who runs it
SELECT 
    'Universal access test' as test_name,
...
RAISE NOTICE 'Universal access policies have been implemented. All authenticated users should now see ALL data.';